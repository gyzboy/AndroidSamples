...
public class BigFileReadWithMapped {
    ...
    public BigFileReadWithMapped(String fileName, int arraySize) throws IOException {
    ...
    public static void main(String[] args) throws IOException {
        BigFileReadWithMapped reader = new BigFileReadWithMapped("/home/zfh/movie.mkv", 65536);
