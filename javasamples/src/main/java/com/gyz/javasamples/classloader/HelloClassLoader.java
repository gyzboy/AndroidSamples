...
public class HelloClassLoader {
    ...
    private static String packageName = "com.gyz.javasamples";
...
//        loadClassByDifferentLoader();
    ...
    private static void loadNetworkClass() throws ClassNotFoundException {
        String className = packageName + ".classloader.NetworkClass";
    ...
    private static void loadFileSystemClass() throws ClassNotFoundException {
        String className = packageName + ".classloader.LocalClassCopy";
    ...
    private static void loadClassByDifferentLoader() throws ClassNotFoundException {
        ...
        Class clazz1 = classLoader1.loadClass(packageName + ".classloader.LocalClass");
        Class clazz2 = classLoader2.loadClass(packageName + ".classloader.LocalClass");
...
//        System.out.println(ClassLoader.getSystemClassLoader()); // AppClassLoader
    ...
    private static void loadClass() throws ClassNotFoundException {
        ...
        Class<?> clazz1 = appClassLoader.loadClass(PathUtils.localPath("MusicPlayer2"));
        System.out.println(clazz1.getClassLoader());

        Class<?> clazz2 = Class.forName(PathUtils.localPath("MusicPlayer2"));
