...
package com.gyz.androidsamples.activity;
...
public class ASActivityRecreate extends Activity {

    private final String TAG = ASActivityRecreate.class.getSimpleName();
    int mCurTheme;
    ...
    private OnClickListener mRecreateListener = new OnClickListener() {
        public void onClick(View v) {
            //新建一个activity，上一个activity的生命周期会走到onDestroy,类似于configureChanges
            recreate();
        }
    };
}
