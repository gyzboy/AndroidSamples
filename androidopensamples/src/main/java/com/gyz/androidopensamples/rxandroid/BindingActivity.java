...
public class BindingActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mTToolbar = (Toolbar) findViewById(R.id.rxbinding_t_toolbar);
        mEtReactiveApproach = (EditText) findViewById(R.id.rxbinding_et_reactive_approach);
        mEtUsualApproach = (EditText) findViewById(R.id.rxbinding_et_usual_approach);
        mTvShow = (TextView) findViewById(R.id.rxbinding_tv_show);
        mFabFab = (FloatingActionButton) findViewById(R.id.rxbinding_fab_fab);
