package com.gyz.androidopensamples.multithreaddownload;
...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_multi_download_main);
    ...
    private final class ButtonClickListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            int i = v.getId();
            if (i == R.id.downloadbutton) {
                String path = pathText.getText().toString();
                if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                    File saveDir = Environment.getExternalStorageDirectory();
                    download(path, saveDir);
                } else {
                    Toast.makeText(getApplicationContext(), "sdcard Error", Toast.LENGTH_SHORT).show();
                }
