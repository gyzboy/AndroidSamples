package com.gyz.androidopensamples.weex;
...
public class WeexMainActivity extends AbstractWeexActivity{
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    if(!WXSoInstallMgrSdk.isCPUSupport()){
      ...
      mTipView.setText("CPU NOT SUPPORT");
      return;
    }
    ...
    mReloadReceiver=new BroadcastReceiver() {
      ...
      public void onReceive(Context context, Intent intent) {
        createWeexInstance();
        if(TextUtils.equals(CURRENT_IP,DEFAULT_IP)){
          renderPage(WXFileUtils.loadAsset("index.js", WeexMainActivity.this),WEEX_INDEX_URL);
        }else{
          renderPageByURL(WEEX_INDEX_URL);
        }
        mProgressBar.setVisibility(View.VISIBLE);
  ...
  public boolean onCreateOptionsMenu(Menu menu) {
    if(TextUtils.equals(CURRENT_IP,DEFAULT_IP)){
      ...
      getMenuInflater().inflate(R.menu.weex_main, menu);
    }
    return true;
  }
