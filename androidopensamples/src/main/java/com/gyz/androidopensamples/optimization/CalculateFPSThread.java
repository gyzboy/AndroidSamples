package com.gyz.androidopensamples.optimization;
...
public class CalculateFPSThread extends Thread {
    private static final String TAG = CalculateFPSThread.class.getSimpleName();
    ...
    public CalculateFPSThread(SurfaceHolder surfaceHolder) {
        super();
