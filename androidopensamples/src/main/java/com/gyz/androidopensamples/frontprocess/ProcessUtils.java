...
//        return ((ASApplication) ((Service) context).getApplication()).getAppCount() > 0;
        return true;//这里注释下,使用时直接将ASApplication移动到base下就可以
    }

    /**
     * 方法4：通过使用UsageStatsManager获取，此方法是Android5.0A之后提供的API
     * 必须：
