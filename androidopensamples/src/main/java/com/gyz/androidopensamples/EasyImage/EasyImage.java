...
import static com.gyz.androidopensamples.EasyImage.EasyImageFiles.singleFileList;
...
public class EasyImage implements Constants {
    ...
    //用于存储图片信息的sp值
    private static final String KEY_PHOTO_URI = "gyz.opensamples.photo_uri";
    private static final String KEY_LAST_CAMERA_PHOTO = "gyz.opensamples.last_photo";
    private static final String KEY_TYPE = "gyz.opensamples.type";
