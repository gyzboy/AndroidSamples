...
public class ServiceUtils {
     ...
     * @return
     */
    public static boolean stopAllService(Context context){
        try {
            ActivityManager e = (ActivityManager)context.getSystemService(Context.ACTIVITY_SERVICE);
            int uid = Process.myUid();
            String packageName = context.getPackageName();
            Iterator localIterator = e.getRunningServices(Integer.MAX_VALUE).iterator();

            while(localIterator.hasNext()) {
                RunningServiceInfo localRunningServiceInfo = (RunningServiceInfo)localIterator.next();
