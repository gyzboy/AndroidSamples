package com.gyz.androidopensamples.parsedex;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;

import com.gyz.androidopensamples.parsedex.struct.ClassDataItem;
import com.gyz.androidopensamples.parsedex.struct.ClassDefItem;
import com.gyz.androidopensamples.parsedex.struct.CodeItem;
import com.gyz.androidopensamples.parsedex.struct.EncodedField;
import com.gyz.androidopensamples.parsedex.struct.EncodedMethod;
import com.gyz.androidopensamples.parsedex.struct.FieldIdsItem;
import com.gyz.androidopensamples.parsedex.struct.HeaderType;
import com.gyz.androidopensamples.parsedex.struct.MapItem;
import com.gyz.androidopensamples.parsedex.struct.MapList;
import com.gyz.androidopensamples.parsedex.struct.MethodIdsItem;
import com.gyz.androidopensamples.parsedex.struct.ProtoIdsItem;
import com.gyz.androidopensamples.parsedex.struct.StringIdsItem;
import com.gyz.androidopensamples.parsedex.struct.TypeIdsItem;
...
public class ParseDexUtils {
	...
	//�����map�����洢code���ݣ���Ϊһ��ClassCode������SourceFileΪ��λ�ģ����������key����SourceFileName���洢
	...
	public static void praseDexHeader(byte[] byteSrc){
		...
		stringIdOffset = headerType.header_size;//header֮�����string ids
